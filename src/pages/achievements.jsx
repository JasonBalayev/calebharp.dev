  ...
  return (
    ...
    >
      <div className="relative">
        {image && (
          <div className="relative h-64 sm:h-80 md:h-[28rem] overflow-hidden w-full">
            ...
            >
              <motion.div 
                className="h-[1px] w-1/3 bg-blue-500/30 absolute top-[30%] right-0"
                whileHover={{ width: "50%", opacity: 0.6 }}
              ></motion.div>
              <motion.div 
                className="h-[1px] w-1/4 bg-blue-500/30 absolute top-[70%] left-0"
                whileHover={{ width: "40%", opacity: 0.6 }}
              ></motion.div>
              <motion.div 
                className="w-[1px] h-1/2 bg-blue-500/30 absolute left-[30%] bottom-0"
                whileHover={{ height: "70%", opacity: 0.6 }}
              ></motion.div>
              <motion.div 
                className="w-[1px] h-1/3 bg-blue-500/30 absolute right-[20%] top-0"
      ...
      <div className="p-5 sm:p-6">
        <motion.h3 
          className="text-xl sm:text-2xl font-bold mb-3 text-blue-400 font-spaceGrotesk"
          whileHover={{ 
            color: "#60a5fa", 
            scale: 1.01,
            x: 5,
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
          {technologies && (
            <motion.div 
              className="bg-black/50 p-3 rounded-lg border border-blue-500/20"
              whileHover={{ 
          ...
          {team && (
            ...
            >
              <div className="text-blue-400 font-semibold mb-1 text-sm">Team Members</div>
          ...
          >
            ...
            <div className="grid grid-cols-1 gap-8 mb-16 max-w-5xl mx-auto">
              <AchievementCard 
                ...
                team="Caleb Bennett-Harper, Saad Naji, Nikhil Ramchandani, Gabriel Ginsberg"
              ...
              <AchievementCard 
                ...
                team="Solo Project - Caleb Bennett-Harper"
...
export const Head = () => <title>Achievements | Caleb Bennett-Harper</title>; 